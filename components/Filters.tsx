  ...
  return (
    <div ref={ref} className="relative col-span-2">
      <button
        ...
        className="flex h-9 w-full cursor-pointer items-center justify-between rounded-full border-0 border-white bg-ui pl-4 pr-3 font-medium text-ui-contrast shadow-sm hover:border-2 hover:shadow-inner focus:border-2 focus:shadow-inner"
      >
